...
Reviewed company examples include Italian "Sa" and any entry combining SARL with cooperative wording; Company wins under the stated precedence.
...
An explicitly foreign-domiciled Foundation or Association remains Non-Profit / Cooperative because that category precedes Foreign Entity / Branch. "Joint Inheritance Rights" maps to Partnership under the reviewed policy.
